...
class DopUsV2(nn.Module):
    ...
    def __init__(self, feature_scale=8, n_classes=1, is_deconv=True, in_channels=1, is_batchnorm=True):
        ...
        self.convGRUDoppler = ConvGRU(input_size=filters[4], hidden_sizes=[64, 64, 128],
    ...
    def forward(self, inputs, hidden):
        ...
        center_doppler = self.convGRUDoppler(center_doppler, hidden)

        center = self.center_concat(torch.cat([center_doppler[-1], center_bmode], 1))
